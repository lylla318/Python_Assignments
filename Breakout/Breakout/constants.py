...
This module consists of global constants for the game Breakout.  These constants 
...
BRICK_Y_OFFSET = 70
#: the offset of the leftmost brick from the game frame
BRICK_X_OFFSET = 0
...
STATE_ACTIVE    = 3
#: state when game is over, all lives lost
STATE_COMPLETE = 4
